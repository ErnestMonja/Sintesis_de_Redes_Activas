...
\begin{itemize}
    ...
    \begin{equation}
        ...
        Q_p = \frac{1}{\sqrt{2}}
    \end{equation}
     y por lo tanto, reemplazando lo obtenido en (\ref{eq_10}) con la expresión encontrada de (\ref{eq_8}) y ademas tomando raiz cuadrada en ambos lados de la ecuación, se tiene que:
     \begin{equation}
         \label{eq_11}
    ...
    \end{equation}
    Si definimos que: $x=\Omega_G^2$ y aplicando lo deducido en (\ref{eq_10}), el sistema se simplifica a una ecuación cuadrática igual a:
    \begin{equation}
        \label{eq_17}
        x^2 + 2x - 1 = 0
    \end{equation}
    ...
    \end{equation}
    Si definimos a $x=\Omega_G^2$ se llega a:
    \begin{equation}
        \label{eq_31}
        x^2 + 3x - 1 = 0
    \end{equation}
    Nuevamente, resolviendo esta ecuación cuadrática y tomando unicamente la solución positiva, se tiene que: $x_1=0,3027$ tal que: $\Omega_G = \sqrt{x_1} = \sqrt{0,3027} = 0,55$ y por lo tanto: $\omega_G = \Omega_G \ \omega_p = 0,55 \ \omega_p$. Finalmente, el margen de fase asociado a este caso es igual a:
    \begin{equation}
        \label{eq_32}
        M\phi = \ang{180} + \arg(T(j\Omega_G))
    \end{equation}
...
\end{equation}
Reemplazando a $x$ por $\Omega_H^2$, se deduce finalmente que:
\begin{equation}
    \label{eq_39}
...
\end{equation}
Reemplazando a $x$ por $\Omega_G^2$, se deduce finalmente que:
\begin{equation}
    \label{eq_44}
