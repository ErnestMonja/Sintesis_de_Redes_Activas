...
\begin{equation}
    \label{eq_62}
    S_{k}^{\frac{\omega_{p}}{Q_{p}}} = \frac{k}{\frac{\omega_{p}}{Q_{p}}} \frac{\partial}{\partial k} \left(\frac{\omega_{p}}{Q_{p}}\right) = \frac{-\frac{k}{R_{2}C_{2}}}{\frac{1}{R_{1}C_{1}} + \frac{1}{R_{2}C_{1}} + \frac{1-k}{R_{2}C_{2}}}
\end{equation}
